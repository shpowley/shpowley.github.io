var CANVAS = {
  ...
  init: function(container, dimen) {
    ...
    function _addBuffer() {
      _buffer.push(new _createCanvas());
    }
    ...
    function _scaleToWindow(fullscreen) {
      ...
      _obj.style[UTIL.getSupported("transform")] = "scale(" + Math.min(scaleX, scaleY) + ")";
    }
    ...
    if (dimen && dimen.scale) {
      if (dimen.scale === CANVAS.SCALE.RATIO && dimen.ratio && dimen.ratio !== 1) {
