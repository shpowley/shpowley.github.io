    ...
    var
      ...
      _STATES = {
        MOTION: {
          ...
          preload: function() {
            this.load.image(_R.ufo.id, _R.ufo.location);
          ...
          create: function() {
            ...
            this.UFO = this.add.sprite(0, 0, _R.ufo.id);
